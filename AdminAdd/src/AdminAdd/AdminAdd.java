	...
	private void initialize() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    stmt.execute("insert into hotel values ('"+txthotel_id.getText()+"','"+txtlocation.getText()+"','"+txthotel_name.getText()+"',null,null)");
		...
		btnAdd.setBounds(241, 266, 97, 25);
		panel.add(btnAdd);
		...
		btnAdd_1.setBounds(239, 298, 97, 25);
		...
		btnAdd_2.setBounds(246, 284, 97, 25);
		...
		btnAdd_3.setBounds(198, 261, 97, 25);
